...
namespace BossArenaSubWorld.Integrations
{
    public class CalamityIntegration : ModSystem
    {
        ...
        // subworld's state). NOTE: The Old Duke itself was removed from this project's v1 boss
        // roster (quick task 260815-024, see .planning/debug/old-duke-immediate-despawn-plain-arena.md
        // Resolution) despite this fix being implemented -- this helper is KEPT because it also
        // benefits Providence/Profaned Guardians/Astrum Deus/Astrum Aureus's Infernum-conditional
        // gating correctness, not just Old Duke's.
