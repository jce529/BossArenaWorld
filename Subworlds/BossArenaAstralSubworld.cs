...
namespace BossArenaSubWorld.Subworlds
{
	...
	public class BossArenaAstralSubworld : Subworld
	{
		...
		public override List<GenPass> Tasks => new()
		{
			...
			new ArenaPolishPass("Astral Arena Polish", 1f, surfaceY: 400, thickness: 15, upperTierCount: 4, lowerTierCount: 2, tierSpacing: 26, torchInterval: 30, torchStyle: 4, boundaryMargin: 60)
		};
