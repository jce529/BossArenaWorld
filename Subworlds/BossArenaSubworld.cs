...
namespace BossArenaSubWorld.Subworlds
{
	...
	public class BossArenaSubworld : Subworld
	{
		...
		public override List<GenPass> Tasks => new()
		{
			...
			new ArenaPolishPass("Arena Polish", 1f, surfaceY: 400, thickness: 15, upperTierCount: 4, lowerTierCount: 2, tierSpacing: 26, torchInterval: 30, torchStyle: 0, boundaryMargin: 60)
		};
